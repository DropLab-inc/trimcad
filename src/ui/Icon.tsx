...
const GLYPHS: Record<IconName, ReactElement> = {
  ...
  // An open manual: two pages meeting at the spine.
  book: (
    <g>
      <path d="M4 5.5 C 7 4.2, 9.5 4.2, 12 5.7 C 14.5 4.2, 17 4.2, 20 5.5 L20 18.5 C 17 17.2, 14.5 17.2, 12 18.7 C 9.5 17.2, 7 17.2, 4 18.5 Z" />
      <path className="accent" d="M12 5.7 L12 18.7" />
    </g>
  ),
  // A suggestion arriving: speech with a plus in it.
  idea: (
    <g>
      <path d="M4 5 L20 5 L20 15.5 L12.5 15.5 L8 19.5 L8 15.5 L4 15.5 Z" />
      <path className="accent" d="M12 8.5 L12 12.5 M10 10.5 L14 10.5" />
    </g>
  ),
  heart: (
    <g>
      <path d="M12 20.2 C 5.2 15.6, 3.2 11.9, 3.2 9.4 A 4.4 4.4 0 0 1 12 7.6 A 4.4 4.4 0 0 1 20.8 9.4 C 20.8 11.9, 18.8 15.6, 12 20.2 Z" />
    </g>
  ),
  // Something to fix: a body, legs and antennae.
  bug: (
    <g>
      <ellipse cx={12} cy={13} rx={4.8} ry={6} />
      <path d="M7.4 10 L4 8 M7.3 13 L3.4 13 M7.4 16 L4 18 M16.6 10 L20 8 M16.7 13 L20.6 13 M16.6 16 L20 18" />
      <path className="accent" d="M9.6 7.2 L8.2 4.6 M14.4 7.2 L15.8 4.6" />
    </g>
  ),
  // The mark is a solid silhouette, so this one glyph opts out of the stroke style.
  github: (
    <g transform="translate(3.4 3.4) scale(1.075)">
      <path
        fill="currentColor"
        stroke="none"
  ...
  search: (
    <g>
      ...
      <path className="accent" d="M15 15 L20.5 20.5" />
    </g>
  ),
  refresh: (
    <g>
      <path d="M4.8 12 A 7.2 7.2 0 1 1 7.6 17.8" />
      <path className="accent" d="M4 8 L4.8 12 L8.8 11.2" />
    </g>
  ),
  external: (
    <g>
      <path d="M14 4 L20 4 L20 10" />
      <path className="accent" d="M20 4 L12 12" />
      <path d="M18 14 L18 20 L4 20 L4 6 L10 6" />
    </g>
  ),
  star: (
    <g>
      <path d="M12 3.2 L14.7 9.2 L21 9.9 L16.3 14.3 L17.6 20.6 L12 17.4 L6.4 20.6 L7.7 14.3 L3 9.9 L9.3 9.2 Z" />
    </g>
  ),
  // Support for a request, drawn the way a person gives it.
  thumb: (
    <g>
